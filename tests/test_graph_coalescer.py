...
def test_filter_enrichment_results_s1():
    ...
    result1 = Enrichment(8.033689062162034e-11, 'HP:0020110', '{"predicate": "biolink:causes"}', True, 2, 4, 2,
                         ['CHEBI:8874', 'CHEBI:53289', 'CHEBI:42944'], 'biolink:DiseaseOrPhenotypicFeature')
    result2 = Enrichment(9.161641498909993e-11, 'HP:0020110', '{"predicate": "biolink:contributes_to"}', True, 2, 4, 2,
                         ['CHEBI:8874', 'CHEBI:53289', 'CHEBI:64312'], 'biolink:DiseaseOrPhenotypicFeature')
    result3 = Enrichment(1.3168191577498547e-10, 'HP:0020110', '{"predicate": "biolink:has_adverse_event"}', True, 2, 4,
                         2, ['CHEBI:8874', 'CHEBI:53289', 'CHEBI:64312'], 'biolink:DiseaseOrPhenotypicFeature')
    result4 = Enrichment(1.3168191577498547e-10, 'HP:0020110', '{"predicate": "biolink:affects"}', True, 2, 4, 2,
                         ['CHEBI:8874', 'CHEBI:53289', 'CHEBI:64312'], 'biolink:DiseaseOrPhenotypicFeature')
...
def test_filter_enrichment_results_S2():
    ...
    result1 = Enrichment(1.7108004493514417e-72, 'MONDO:0004975', '{"predicate": "biolink:treats"}', False, 16, 19,
                         1366955.0,
                         ['UNII:12PYH0FTU9', 'CHEBI:45980', 'CHEBI:125612', 'CHEBI:15355', 'CHEBI:3048', 'CHEBI:53289',
                          'CHEBI:135927', 'CHEBI:64312', 'UNII:105J35OE21', 'CHEBI:42944', 'CHEBI:8874', 'CHEBI:8888',
                          'CHEBI:57589', 'CHEBI:9086', 'CHEBI:8707', 'CHEBI:5613'], 'biolink:Disease')
    result2 = Enrichment(3.0839908185924632e-61, 'MONDO:0004975',
                         '{"predicate": "biolink:treats_or_applied_or_studied_to_treat"}', False, 16, 96, 1366955.0,
                         ['UNII:12PYH0FTU9', 'CHEBI:45980', 'CHEBI:125612', 'CHEBI:15355', 'CHEBI:3048', 'CHEBI:53289',
                          'CHEBI:135927', 'CHEBI:64312', 'UNII:105J35OE21', 'CHEBI:42944', 'CHEBI:8874', 'CHEBI:8888',
                          'CHEBI:57589', 'CHEBI:9086', 'CHEBI:8707', 'CHEBI:5613'], 'biolink:Disease')
    result3 = Enrichment(3.7469289680403445e-31, 'MONDO:0004975', '{"predicate": "biolink:affects"}', False, 16, 13,
                         1366955.0,
                         ['CHEBI:15355', 'CHEBI:3048', 'CHEBI:53289', 'CHEBI:8888', 'CHEBI:9086', 'CHEBI:8707',
                          'CHEBI:5613'], 'biolink:Disease')
    result4 = Enrichment(1.6662626195823426e-28, 'MONDO:0004975', '{"predicate": "biolink:ameliorates_condition"}',
                         False, 16, 6, 1366955.0,
                         ['CHEBI:15355', 'CHEBI:3048', 'CHEBI:8888', 'CHEBI:9086', 'CHEBI:8707', 'CHEBI:5613'],
                         'biolink:Disease')
    result5 = Enrichment(7.022661981030352e-05, 'MONDO:0004975', '{"predicate": "biolink:has_adverse_event"}', False,
                         16, 6, 1366955.0, ['CHEBI:53289'], 'biolink:Disease')
...
def test_filter_enrichment_results_s3():
    ...
    Scenario 3***************: REAL EXAMPLE FROM AC
        ...
        * Find the ancestors of each of the results then return the last child.
        ...
        Output: [result1]
    """
    result1 = Enrichment(1.2043826479125558e-07, 'HP:0032141', '{"predicate": "biolink:causes"}', False, 61, 11,
                         1366955.0, ['CHEBI:15407', 'CHEBI:51209'], 'biolink:Disease')
    result2 = Enrichment(1.2043826479125558e-07, 'HP:0032141', '{"predicate": "biolink:related_to"}', True, 61, 11,
                         1366955.0, ['CHEBI:15407', 'CHEBI:51209'], 'biolink:Disease')
    result3 = Enrichment(1.2043826479125558e-07, 'HP:0032141', '{"predicate": "biolink:contributes_to"}', False, 61, 11,
                         1366955.0, ['CHEBI:15407', 'CHEBI:51209'], 'biolink:Disease')
...
def test_filter_enrichment_results_s4():
    ...
    result1 = Enrichment(5.62677119993497e-16, 'MONDO:0006032', '{"predicate": "biolink:contributes_to"}', False, 61,
                         193, 1366955.0,
                         ['CHEBI:408174', 'CHEBI:5147', 'CHEBI:6888', 'CHEBI:8378', 'CHEBI:8382', 'CHEBI:92511'],
                         'biolink:Disease')
    result2 = Enrichment(6.984714344422767e-26, 'MONDO:0006032', '{"predicate": "biolink:related_to"}', True, 61, 310,
                         1366955.0,
                         ['CHEBI:28918', 'CHEBI:408174', 'CHEBI:5134', 'CHEBI:5147', 'CHEBI:5551', 'CHEBI:6888',
                          'CHEBI:8378', 'CHEBI:8382', 'CHEBI:92511', 'UNII:420K487FSG'], 'biolink:Disease')
    result3 = Enrichment(2.688166355839941e-06, 'MONDO:0006032',
                         '{"predicate": "biolink:treats_or_applied_or_studied_to_treat"}', False, 61, 52, 1366955.0,
                         ['CHEBI:28918', 'CHEBI:4463'], 'biolink:Disease')
    result4 = Enrichment(2.8008696832786763e-17, 'MONDO:0006032', '{"predicate": "biolink:has_adverse_event"}', False,
                         61, 117, 1366955.0,
                         ['CHEBI:28918', 'CHEBI:5134', 'CHEBI:5551', 'CHEBI:6888', 'CHEBI:8378', 'UNII:420K487FSG'],
                         'biolink:Disease')
    result5 = Enrichment(3.9591314521010225e-08, 'MONDO:0006032', '{"predicate": "biolink:causes"}', False, 61, 139,
                         1366955.0, ['CHEBI:408174', 'CHEBI:5147', 'CHEBI:92511'], 'biolink:Disease')
...
def test_filter_enrichment_results_s5():
    ...
    result1 = Enrichment(0.0005353534265271418, 'NCBIGene:632',
                         '{"object_aspect_qualifier": "secretion", "predicate": "biolink:affects"}', False, 61, 12,
                         1366955.0, ['CHEBI:6888'], 'biolink:Gene')
    result2 = Enrichment(0.0005353534265271418, 'NCBIGene:632',
                         '{"object_aspect_qualifier": "transport", "predicate": "biolink:affects"}', False, 61, 12,
                         1366955.0, ['CHEBI:6888'], 'biolink:Gene')
    result3 = Enrichment(0.00022309876782534895, 'NCBIGene:632',
                         '{"object_aspect_qualifier": "secretion", "object_direction_qualifier": "decreased", "predicate": "biolink:affects"}',
                         False, 61, 5, 1366955.0, ['CHEBI:6888'], 'biolink:Gene')
    result4 = Enrichment(0.00022309876782534895, 'NCBIGene:632',
                         '{"object_aspect_qualifier": "transport", "object_direction_qualifier": "decreased", "predicate": "biolink:affects"}',
                         False, 61, 5, 1366955.0, ['CHEBI:6888'], 'biolink:Gene')
    result5 = Enrichment(3.980364423629894e-07, 'NCBIGene:632', '{"predicate": "biolink:affects"}', False, 61, 20,
                         1366955.0, ['CHEBI:4463', 'CHEBI:6888'], 'biolink:Gene')
    result6 = Enrichment(6.725615356368366e-07, 'NCBIGene:632', '{"predicate": "biolink:related_to"}', False, 61, 26,
                         1366955.0, ['CHEBI:4463', 'CHEBI:6888'], 'biolink:Gene')
    result7 = Enrichment(0.00017848299646047716, 'NCBIGene:632',
                         '{"object_aspect_qualifier": "expression", "predicate": "biolink:affects"}', False, 61, 4,
                         1366955.0, ['CHEBI:4463'], 'biolink:Gene')
    result8 = Enrichment(0.00017848299646047716, 'NCBIGene:632',
                         '{"object_aspect_qualifier": "expression", "object_direction_qualifier": "increased", "predicate": "biolink:affects"}',
                         False, 61, 4, 1366955.0, ['CHEBI:4463'], 'biolink:Gene')
    result9 = Enrichment(0.00017848299646047716, 'NCBIGene:632',
                         '{"object_aspect_qualifier": "abundance", "predicate": "biolink:affects"}', False, 61, 4,
                         1366955.0, ['CHEBI:4463'], 'biolink:Gene')
    result10 = Enrichment(0.00017848299646047716, 'NCBIGene:632',
                          '{"object_aspect_qualifier": "abundance", "object_direction_qualifier": "increased", "predicate": "biolink:affects"}',
                          False, 61, 4, 1366955.0, ['CHEBI:4463'], 'biolink:Gene')
    result11 = Enrichment(0.0003123243378767348, 'NCBIGene:632',
                          '{"object_aspect_qualifier": "activity_or_abundance", "predicate": "biolink:affects"}', False,
                          61, 7, 1366955.0, ['CHEBI:4463'], 'biolink:Gene')
    result12 = Enrichment(0.00026771254826782066, 'NCBIGene:632',
                          '{"object_aspect_qualifier": "activity_or_abundance", "object_direction_qualifier": "increased", "predicate": "biolink:affects"}',
                          False, 61, 6, 1366955.0, ['CHEBI:4463'], 'biolink:Gene')

    result = gc.filter_result_hierarchies(
...
def test_filter_enrichment_results_s6():
    ...
    result1 = Enrichment(6.440871527077959e-35, 'NCBIGene:154',
                         '{"object_aspect_qualifier": "activity", "predicate": "biolink:affects"}', False, 61, 2837,
                         1366955.0, ['19'], 'biolink:Gene')
    result2 = Enrichment(8.841059601006888e-35, 'NCBIGene:154',
                         '{"object_aspect_qualifier": "activity_or_abundance", "predicate": "biolink:affects"}', False,
                         61, 2885, 1366955.0, ['19'], 'biolink:Gene')
    result3 = Enrichment(1.2708916953779429e-34, 'NCBIGene:154', '{"predicate": "biolink:affects"}', False, 61, 5,
                         1366955.0, ['CHEBI:6888'], 'biolink:Gene')
    result4 = Enrichment(1.451342937454794e-32, 'NCBIGene:154', '{"predicate": "biolink:related_to"}', False, 61, 5,
                         1366955.0, ['CHEBI:6888'], 'biolink:Gene')
    result5 = Enrichment(2.512830362134677e-36, 'NCBIGene:154',
                         '{"object_aspect_qualifier": "activity", "object_direction_qualifier": "increased", "predicate": "biolink:affects"}',
                         False, 61, 1789, 1366955.0, ['18'], 'biolink:Gene')
    result6 = Enrichment(2.615464485693035e-36, 'NCBIGene:154',
                         '{"object_aspect_qualifier": "activity_or_abundance", "object_direction_qualifier": "increased", "predicate": "biolink:affects"}',
                         False, 61, 1793, 1366955.0, ['18'], 'biolink:Gene')
    result7 = Enrichment(3.750524768721316e-27, 'NCBIGene:154', '{"predicate": "biolink:binds"}', True, 61, 746,
                         1366955.0, ['12'], 'biolink:Gene')
    result8 = Enrichment(1.3889291678789253e-34, 'NCBIGene:154',
                         '{"predicate": "biolink:directly_physically_interacts_with"}', True, 61, 4, 1366955.0, ['15'],
                         'biolink:Gene')
    result9 = Enrichment(6.37300413954452e-37, 'NCBIGene:154', '{"predicate": "biolink:interacts_with"}', False, 61, 4,
                         1366955.0, ['CHEBI:4463'], 'biolink:Gene')
    result10 = Enrichment(2.50950277122731e-31, 'NCBIGene:154', '{"predicate": "biolink:regulates"}', False, 61, 37,
                          1366955.0, ['9'], 'biolink:Gene')
    result11 = Enrichment(4.557847849630573e-36, 'NCBIGene:154',
                          '{"object_direction_qualifier": "upregulates", "predicate": "biolink:regulates"}', False, 61,
                          7, 1366955.0, ['9'], 'biolink:Gene')
    result12 = Enrichment(8.924548060814318e-05, 'NCBIGene:154', '{"predicate": "biolink:increases_response_to"}', True,
                          61, 2, 1366955.0, ['CHEBI:4463'], 'biolink:Gene')
    result13 = Enrichment(1.0822387821668951e-14, 'NCBIGene:154',
                          '{"object_aspect_qualifier": "molecular_interaction", "predicate": "biolink:affects"}', False,
                          61, 16, 1366955.0, ['4'], 'biolink:Gene')
    result14 = Enrichment(1.9435986995566893e-41, 'NCBIGene:154',
                          '{"object_aspect_qualifier": "abundance", "predicate": "biolink:affects"}', False, 61, 48,
                          1366955.0, ['12'], 'biolink:Gene')
    result15 = Enrichment(5.402888231040584e-16, 'NCBIGene:154',
                          '{"object_aspect_qualifier": "activity", "object_direction_qualifier": "decreased", "predicate": "biolink:affects"}',
                          True, 61, 2, 1366955.0, ['8'], 'biolink:Gene')
    result16 = Enrichment(0.0004907515897535203, 'NCBIGene:154', '{"predicate": "biolink:affects_response_to"}', False,
                          61, 37, 1366955.0, ['1'], 'biolink:Gene')
    result17 = Enrichment(0.0007137408715038871, 'NCBIGene:154', '{"predicate": "biolink:affects"}', False, 61, 7,
                          1366955.0, ['16'], 'biolink:Gene')
    result18 = Enrichment(4.062152451583994e-11, 'NCBIGene:154',
                          '{"object_aspect_qualifier": "molecular_interaction", "object_direction_qualifier": "decreased", "predicate": "biolink:affects"}',
                          True, 61, 2, 1366955.0, ['3'], 'biolink:Gene')
    result19 = Enrichment(3.9824963795193066e-09, 'NCBIGene:154', '{"predicate": "biolink:positively_correlated_with"}',
                          False, 61, 37, 1366955.0, ['9'], 'biolink:Gene')
    result20 = Enrichment(4.462373594297634e-05, 'NCBIGene:154',
                          '{"object_aspect_qualifier": "localization", "object_direction_qualifier": "increased", "predicate": "biolink:affects"}',
                          False, 61, 7, 1366955.0, ['1'], 'biolink:Gene')
...
def test_streamline_children_to_parent():
    ...
    """
    chilren_to_parent_mapping = {
        '{"predicate": "biolink:directly_physically_interacts_with"}': {'{"predicate": "biolink:interacts_with"}'},
        '{"predicate": "biolink:binds"}': {'{"predicate": "biolink:related_to"}'},
        '{"object_aspect_qualifier": "activity_or_abundance", "predicate": "biolink:affects"}': {
            '{"predicate": "biolink:related_to"}'},
        '{"object_aspect_qualifier": "activity", "predicate": "biolink:affects"}': {
            '{"predicate": "biolink:related_to"}'},
        '{"object_aspect_qualifier": "activity", "object_direction_qualifier": "decreased", "predicate": "biolink:affects"}': {
            '{"predicate": "biolink:related_to"}'},
        '{"object_aspect_qualifier": "activity_or_abundance", "object_direction_qualifier": "decreased", "predicate": "biolink:affects"}': {
            '{"predicate": "biolink:related_to"}'},
        '{"predicate": "biolink:affects"}': {'{"predicate": "biolink:related_to"}'},
        '{"object_aspect_qualifier": "abundance", "predicate": "biolink:affects"}': {
            '{"predicate": "biolink:related_to"}'},
        '{"object_aspect_qualifier": "degradation", "predicate": "biolink:affects"}': {
            '{"predicate": "biolink:related_to"}'},
        '{"object_aspect_qualifier": "degradation", "object_direction_qualifier": "increased", "predicate": "biolink:affects"}': {
            '{"predicate": "biolink:related_to"}'}
        }
